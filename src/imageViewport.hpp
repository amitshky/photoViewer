...
private:
    ...
    /**
     * Loads image in the current index from `_images`
     */
...
private:
    ...
    ImageViewportInfo _info; // holds data to instantiate ImageViewport object
    int64_t _currentImageIdx;
    Rectangle _dstRectangle; // to render the image texture
    Camera2D _camera;
